// Minggu 7 — IEEE 802.15.4 P2P (raw frame), Node2 = penerima (short addr 0x0002)
#include <Arduino.h>
...
void setup() {
  Serial.begin(115200);
  Serial.println("Node2 (802.15.4 receiver) starting...");

  uint8_t ext[] = {0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18};
